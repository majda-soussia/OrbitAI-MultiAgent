...
export default function SignupPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setSuccess(result.message || "Compte créé. Vérifiez votre email pour l'activer.");
    } catch (err) {
    ...
    return (
      <div style={styles.container}>
        <div style={styles.card}>
          <h1 style={styles.title}>Vérifiez votre boîte mail</h1>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Rejoignez Orbit AI Assistant</p>
